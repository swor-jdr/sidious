    ...
    <div class="xl:w-1/2 mx-auto">
        <div class="flex items-center mb-10">
            <h2 class="mr-2 font-semibold font-serif" :class="{'hidden': hideLogoOnSmallScreens, 'sm:block': hideLogoOnSmallScreens}">
                <span class="text-light">H</span>olonews.
            </h2>

            <h2 class="font-normal">— Se connecter</h2>
        </div>
        ...
        <form method="POST" action="{{route('holonews.auth.attempt')}}">
            @csrf

            <div class="input-group">
                <label for="email" class="input-label">Email (Compte Auteur)</label>
            ...
            <div class="flex items-center mb-10">
                ...
                <a href="{{route('holonews.password.forgot')}}" class="no-underline text-primary">Un oubli?</a>
            </div>

            <button type="submit" class="btn-primary">Moi et les probabilités...</button>
        </form>
    </div>
</div>
