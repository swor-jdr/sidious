...
export default {
    ...
    data() {
        return {
            ...
            id: this.$route.params.id || NEW_ID,
     ...
     */
    mounted() {
        document.title = "Edit Post — Holonews.";
    ...
    methods: {
        ...
        save() {
            ...
            this.http().post('/api/posts/' + this.id, this.form).then(response => {
                ...
                if (this.id === NEW_ID) {
                    this.$router.push({name: 'post-edit', params: {id: response.data.entry.id}})
                }
            }).catch(error => {
                this.status = '';
    ...
    <div>
        <page-header>
            ...
            <div class="flex items-center" v-if="ready && entry" slot="right-side">
                ...
                <dropdown class="relative">
                    <button
                        slot="trigger"
                        class="focus:outline-none text-light hover:text-primary h-8"
                    >
                        <svg
                    ...
                    <div
                        slot="content"
                        class="dropdown-content pin-r min-w-dropdown mt-1 text-sm py-2"
                    >
                        <a
                            href="#"
                            @click.prevent="settingsModal"
                        ...
                        <a
                            href="#"
                            @click.prevent="featuredImageModal"
                            class="no-underline text-text-color hover:text-primary w-full block py-2 px-4"
                        >
                            Featured Image
                        </a>
        ...
        <modal v-if="settingsModalShown" @close="closeSettingsModal">
            ...
            <div class="input-group">
                ...
                <select name="author_id" class="input" v-model="form.author_id" id="author_id">
        ...
        <modal v-if="publishingModalShown" @close="publishingModalShown = false">
            <div
                ...
                v-if="form.title == 'Draft' || !form.slug || form.slug.startsWith('draft-')"
            >
            ...
            <div class="mt-10">
                ...
                <button class="btn-sm ml-1 btn-light" @click="publishingModalShown = false">
                    Cancel
                </button>
            </div>
        </modal>
